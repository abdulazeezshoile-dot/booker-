...
export class AddBillingCycleToBillingTables1710850000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('ALTER TABLE "payments" DROP COLUMN IF EXISTS "billing_cycle"');
    await queryRunner.query('ALTER TABLE "subscriptions" DROP COLUMN IF EXISTS "billing_cycle"');
  }
}
